...
getNOAA.bathy(lon1 = -180, lon2 = -150, lat1 = 53, lat2 = 64, resolution=1) -> AKBath
AKBath_xyz <- as.xyz(AKBath) %>%
  mutate(V1=V1+360)
...
CloseMatches <- rubias::close_matching_samples(D = Mixtures %>% 
                                  as_tibble() %>% 
