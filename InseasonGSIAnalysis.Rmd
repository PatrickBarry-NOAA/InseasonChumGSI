...
File2Read <- max(AKRO_Files) #AKRO_Files[which.min(abs(CrntSW-FileWeeks)) ]
...
result in the shoreside sector often having the largest proportion and number of Western Alaska (Coastal Western Alaska, Yukon Fall run, and 
