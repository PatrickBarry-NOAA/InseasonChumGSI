...
```{r Map, eval=T, echo=F, fig.cap='Map of National Marine Fisheries Service management areas within the Bering Sea and Aleutian Islands. Colored areas indicate management areas where chum salmon bycatch has historically occured.',fig.width=4}
